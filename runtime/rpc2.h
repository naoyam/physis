...
// details.
#ifndef PHYSIS_RUNTIME_RPC2_H_
#define PHYSIS_RUNTIME_RPC2_H_
...
class Master2: public Master {
 public:
  Master2(int rank, int num_procs, InterProcComm *ipc,
          __PSStencilRunClientFunction *stencil_runs,
          GridSpaceMPI *gs):
      Master(rank, num_procs, ipc, stencil_runs, gs) {}
  virtual ~Master2() {}
...
class Client2: public Client {
 public:
  Client2(int rank, int num_procs, InterProcComm *ipc,
          __PSStencilRunClientFunction *stencil_runs,
          GridSpaceMPI *gs):
      Client(rank, num_procs, ipc, stencil_runs, gs) {}
  virtual ~Client2() {}
