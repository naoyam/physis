...
void MPICUDATranslator::BuildRunInteriorKernelBody(
  ...
  builder()->BuildRunKernelFuncBody(
...
SgFunctionDeclaration *MPICUDATranslator::BuildRunInteriorKernel(
  ...
  BuildRunInteriorKernelBody(stencil, params, run_func->get_definition()->get_body());
