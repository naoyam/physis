...
#define OFFSET(x, y, z) ((x) + (y) * N + (z) * N * N)
 ...
 __global__ void kernel(REAL *g1, REAL *g2) {
   ...
   float v =
       g1[OFFSET(x, y, zp)] + g1[OFFSET(xn, y, zp)] +
       g1[OFFSET(xp, y, zp)] + g1[OFFSET(x, yn, zp)] +
       g1[OFFSET(xn, yn, zp)] + g1[OFFSET(xp, yn, zp)] +
       g1[OFFSET(x, yp, zp)] + g1[OFFSET(xn, yp, zp)] +
       g1[OFFSET(xp, yp, zp)] +
       // z == 0
       g1[OFFSET(x, y, z)] + g1[OFFSET(xn, y, z)] +
       g1[OFFSET(xp, y, z)] + g1[OFFSET(x, yn, z)] +
       g1[OFFSET(xn, yn, z)] + g1[OFFSET(xp, yn, z)] +
       g1[OFFSET(x, yp, z)] + g1[OFFSET(xn, yp, z)] +
       g1[OFFSET(xp, yp, z)] +
       // z == 1
       g1[OFFSET(x, y, zn)] + g1[OFFSET(xn, y, zn)] +
       g1[OFFSET(xp, y, zn)] + g1[OFFSET(x, yn, zn)] +
       g1[OFFSET(xn, yn, zn)] + g1[OFFSET(xp, yn, zn)] +
       g1[OFFSET(x, yp, zn)] + g1[OFFSET(xn, yp, zn)] +
       g1[OFFSET(xp, yp, zn)];
   g2[OFFSET(x, y, z)] = v;
   return;
 }
